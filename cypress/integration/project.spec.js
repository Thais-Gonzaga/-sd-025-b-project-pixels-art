...
describe('4 - Adicione à página um quadro contendo 25 pixels', () => {
  beforeEach(() => {
    cy.visit('./index.html');
  });
...
describe('6 - Defina a cor preta como cor inicial da paleta de cores. Ao carregar a página a cor preta já deve estar selecionada para pintar os pixels', () => {
  beforeEach(() => {
    cy.visit('./index.html');
  });
...
describe('7 - Crie uma função para selecionar uma cor na paleta de cores e preencher os pixels no quadro', () => {
  beforeEach(() => {
    cy.visit('./index.html');
  });
...
describe('8 - Crie uma função que permita preencher um pixel do quadro com a cor selecionada na paleta de cores', () => {
  beforeEach(() => {
    cy.visit('./index.html');
  });
...
describe('10 - Crie um input que permita à pessoa usuária preencher um novo tamanho para o quadro de pixels', () => {
  beforeEach(() => {
    cy.visit('./index.html');
  });
...
describe('11 - Crie uma função que limite o tamanho mínimo e máximo do quadro de pixels', () => {
  beforeEach(() => {
    cy.visit('./index.html');
  });
...
describe('12 - Crie uma função para gerar as cores aleatoriamente ao carregar a página, com exceção da cor preta', () => {
  beforeEach(() => {
    cy.visit('./index.html');
  });
